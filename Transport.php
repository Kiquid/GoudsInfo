    ...
    <div class="row">
      <div class="col-sm-12 text-center">
        <div class="breadcrum-inner-header">
          <h1>Officials</h1>
          <a href="index.html">Home</a> <i class="fa fa-circle"></i> <a href="#"><span>Transport</span></a> </div>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-md-3 col-sm-4 col-xs-12">
        ...
        <div class="left-slide-slt-block">
          <h3> <a href="categories.html" data-toggle="tooltip" data-placement="top"
            title="The Regional Transport Office or Regional Transport Authority is the organisation of the Indian government"> Categories</a></h3>
        </div>
        <div class="list-group">
            ...
            <a href="#" class="list-group-item" data-toggle="tooltip" data-placement="top"
             title=" Inspects truck accessories, air lines and electric circuits, and reports needed repairs. ">
               <i class="fa fa-hand-o-right"></i> 
      ...
      <div class="col-md-9 col-sm-8 col-xs-12">
        <div class="sorts-by-results">
          <div class="col-md-6 col-sm-6 col-xs-6">
             <span class="result-item-view">           
              <span style="color: #ff4300;"><H1>Gouds in Transport Department</H1></span>           
            </span>
         </div>
           <!--
          <div class="col-md-6 col-sm-6 col-xs-6">           
        ...
        <div class="row">
          <div class="col-md-12 col-sm-8 col-xs-12">
           <p>Transport Department play an important role in society. Transport Department consciousness necessary to develop the Gouda Community.</p>
           <ul style="margin-left: 35px;">
             <li>
               <P class="inner-secon-tl" style="text-align: justify;">To recognize the Transport Department in gouda community</P>
              </li>
             <li>
              ...
              <li>
                  <P class="inner-secon-tl" style="text-align: justify;">
                      To unite all these Transport Department in one track.
                   </P>  
              </li>
        ...
        <div class="row">
          <div class="col-md-5 col-sm-6 col-xs-12">
            <div class="feature-item-container-box listing-item">
              <div class="feature-title-item">
                <img src="images/product/Offi-Chandu.gif" alt="img1" height="45px;"> </div>           
              <div class="feature-box-text">
                <h3><a href="listing_detail.html">Chandhra Shekhar Goud Mamindla</a></h3>
                <a href="#" style="color: #ff4300;"><i class="fa fa-phone" style="color: #ff4300;"></i> +91 994 866 1750</a><BR>
                <a href="#" style="color: #ff4300;"><i class="fa fa-user-md"  style="color: #ff4300;"></i> RTO</a>
                <p>Fathers Name &nbsp; : &nbsp;Mamindla Rama Goud<br>
                  Date of Birth &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;:&nbsp; 30-04-1974<Br>
                  Education&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp; M.Sc, B.Ed.<br>
                  Occupation&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; Regional Transport Officer Ibrahimpatnam, R.R.Dist </p>
              <span style="color: #ffce10;">Family Details</span>
              <p>
                Spouse Name&nbsp; :&nbsp;Sunitha Goud Mamindla<br>
                Children's&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	: Hanish Goud Mamindla  1st Class<br>
                Native Place&nbsp;&NonBreakingSpace;&nbsp;&nbsp;&nbsp;:Rudrur, Nizamabad
              </p>
              <span style="color: #ffce10;">Present Address</span>
              <P>Flat No : 302, Reliance Apartment, Near Asta Laxmi Arch, Kothapet, L.B.Nagar.</P>
              </div>
             </div>
          </div>
          <div class="col-md-5 col-sm-6 col-xs-12">
            <div class="feature-item-container-box listing-item">
              <div class="feature-title-item">
                <img src="images/product/RTA-Ravinder.gif" alt="img2"> 
              </div>       
              <div class="feature-box-text">
                <h3><a href="listing_detail.html">Ravinder Goud Pullemla</a></h3>
                <a href="#" style="color: #ff4300;"><i class="fa fa-phone" style="color: #ff4300;"></i> +91 924 634 5423, 986 665 9183.</a><br>
                <a href="#" style="color: #ff4300;"><i class="glyphicon glyphicon-education" style="color: #ff4300;"></i>&nbsp;  Motor Vehicle Inspector</a>
                <p>Fathers Name &nbsp; : &nbsp; P.Somaiah<br>
                  Date of Birth &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;:&nbsp;  29-11-1967<Br>
                  Education&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;   B.E. (Mechanical)<br>
                  Occupation&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; Motor Vehicle Inspector Driving Test Track, Nagole, HYD </p>
              <span style="color: #ffce10;">Family Details</span>
              <p>
                Spouse Name&nbsp; :&nbsp; P.Anupama<br>
                Children's&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	:  Sai Pranav   5th Class
                Sai Praneeth   2nd Class<br>
                Native Place&nbsp;&NonBreakingSpace;&nbsp;&nbsp;&nbsp;:Narketpally, Nalgonda.
              </p>
              <span style="color: #ffce10;">Present  Address</span>
              <P>Flat No : 201, C.M. Residency, West Maredpally, Secunderabad</P>
              </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="feature-item-container-box listing-item">
              <div class="feature-title-item">
               <img src="images/product/Subhash.gif" alt="img3"> 
              </div>
              <div class="feature-box-text">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="feature-item-container-box listing-item">
              <div class="feature-title-item">               
                <img src="images/product/Famous-KE-Krishna-Big.gif" alt="img4"> </div>              
              <div class="feature-box-text">
                <h3><a href="listing_detail.html">Hello Directory Listing</a></h3>
                <a href="#"><i class="fa fa-phone"></i> +91 087 654 3210</a>
                <p>Eiusmod tempor incidiunt labore velit dolore magna aliqu sed veniam quis nostrud lorem ipsum dolor sit amet consectetur...</p>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="feature-item-container-box listing-item">
              <div class="feature-title-item">
               <img src="images/product/news-image-01.gif" alt="img5"> </div>
               <div class="feature-box-text">
                <h3><a href="listing_detail.html">Hello Directory Listing</a></h3>
                <a href="#"><i class="fa fa-phone"></i> +91 087 654 3210</a>
                <p>Eiusmod tempor incidiunt labore velit dolore magna aliqu sed veniam quis nostrud lorem ipsum dolor sit amet consectetur...</p>
