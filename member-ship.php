    ...
    <div class="row">
      <div class="col-sm-12 text-center">
        <div class="breadcrum-inner-header">
          <h1>MemberShip</h1>
          <a href="index.html">Home</a> <i class="fa fa-circle"></i> <a href="contact.html"><span>MemberShip</span></a> </div>
      </div>
    </div>
  </div>
</div>
<div id="vfx-product-inner-item">
  <div class="container">
    <div class="row">
      ...
      <!--
      <span class="clt-content">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
         Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer
          took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, 
          but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s
           with the release of Letraset sheets containing.<br><br>Lorem Ipsum is simply dummy text of the printing and 
           ...
           galley of type and scrambled it to make a type specimen book.<br><br> It has survived not only five centuries, but also the leap into 
           electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s 
           with the release of Letraset sheets containing.
          </span>-->
      <div class="from-list-lt">
        <div class="col-xs-12 col-lg-8 col-sm-12">
          <form class="form-float form-alt" style="
          margin-left: 220px;
          width: 750px;">
            <div class="row">
              <div class="form-group col-xs-12 col-sm-6"> <span class="from-input-ic"><i class="fa fa-user"></i></span>
                <input class="form-control" required placeholder="Frist Name" type="text">
              </div>
              <div class="form-group col-xs-12 col-sm-6"> <span class="from-input-ic"><i class="fa fa-user"></i></span>
              ...
              <div class="form-group col-xs-12 col-sm-6"> <span class="from-input-ic"><i class="fa fa-phone"></i></span>
               ...
               <div class="form-group col-xs-12 col-sm-6">
                  <button class="dropdown-toggle form-control" type="button" data-toggle="dropdown"
                   style="width: 60%;background-color: #f9f9f9;height: 44px;border:1px solid #f1f1f1;">Profession
                ...
                <div class="form-group col-xs-12 col-sm-6"> <span class="from-input-ic"><i class="fa fa-area-chart"></i></span>
                  <input class="form-control" required placeholder="Disrict" type="text">
                </div> 
