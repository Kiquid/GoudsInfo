    ...
    <div class="row">
      <div class="col-sm-12 text-center">
        <div class="breadcrum-inner-header">
          <h1>Officials</h1>
          <a href="index.php">Home</a> <i class="fa fa-circle"></i> <a href="#"><span>Civil Services</span></a> </div>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="col-md-3 col-sm-4 col-xs-12">
        ...
        <div class="list-group">
            <a href="#" class="list-group-item active" data-toggle="tooltip" data-placement="top"
             title="Is an Indian Administrative Service officer in charge of revenue collection and administration of a district in India.">
                <i class="fa fa-hand-o-right"></i> 
                Collector
                <span class="list-lt">16</span>
            </a> 
            <a href="#" class="list-group-item" data-toggle="tooltip" data-placement="top"
             title="Is the top-most executive official and senior-most civil servant of the Government of India. ">
               <i class="fa fa-hand-o-right"></i> 
               Rtd.Cabinet Secretary
               <span class="list-lt">16</span>
           </a> 
           <a href="#" class="list-group-item" data-toggle="tooltip" data-placement="top"
              title="Is in principle, a member of a commission or an individual who has been given a commission..">
             <i class="fa fa-hand-o-right"></i>            	
              Commissioner
             <span class="list-lt">16</span>
            </a>
           ...
           <a href="#" class="list-group-item" data-toggle="tooltip" data-placement="top"
           title="Assistant commissioner is a rank used in many police forces around the globe.">
             <i class="fa fa-hand-o-right"></i> 
             Asst. Commissioner
            <span class="list-lt">15</span>
          </a>
           <a href="#" class="list-group-item" data-toggle="tooltip" data-placement="top"
           title="The Internal Revenue Service is the revenue service of the United States federal government.">
             <i class="fa fa-hand-o-right"></i>         	
                IRS
              <span class="list-lt">09</span>
            </a> 
           <a href="#" class="list-group-item" data-toggle="tooltip" data-placement="top"
           title="A group of executive directors who each play a significant role within the company. ">
             <i class="fa fa-hand-o-right"></i> 
             Managing Director
      ...
      <div class="col-md-9 col-sm-8 col-xs-12">
        <div class="sorts-by-results">
          <div class="col-md-6 col-sm-6 col-xs-6">
             <span class="result-item-view">           
              <span style="color: #ff4300;"><H1>Gouds in Civil Services</H1></span>           
            </span>
         </div>
        </div>
        <div class="row">
          <div class="col-md-12 col-sm-8 col-xs-12">
           <p style="text-align: justify";>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis tenetur 
             similique vel itaque magnam fugit harum, dolorem culpa mollitia ducimus eius amet illum 
             temporibus eum unde reprehenderit quidem delectus pariatur.
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam magnam eius dignissimos iusto itaque. Quos, 
            nostrum dolore velit eveniet fugiat incidunt, repellat aspernatur quaerat, 
            quis non blanditiis nemo facere laudantium.</p>
        ...
        <div class="row">
          <div class="col-md-5 col-sm-6 col-xs-12">
            <div class="feature-item-container-box listing-item">
              <div class="feature-title-item">
                <img src="images/product/Venkatesham.jpg" alt="img1" height="45px;"> </div>           
              <div class="feature-box-text">
                <h3><a href="#"  style="color: #ff4300;">Burra Venkatesham Goud </a></h3>
                <!--
                ...
                <p>Designation &nbsp; : &nbsp;Collector <br>
                  Post & Office &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;:&nbsp; Medak<Br>
                </p>
              </div>
             </div>
          </div>
          <div class="col-md-5 col-sm-6 col-xs-12">
            <div class="feature-item-container-box listing-item">
              <div class="feature-title-item">
                <img src="images/product/img1.png" alt="img2"> 
              </div>       
              <div class="feature-box-text">
                <h3><a href="#" style="color: #ff4300;">T.R. Prasad</a></h3>
                <!--
                <a href="#" ><i class="fa fa-phone" style="color: #ff4300;"></i> +91 924 634 5423, 986 665 9183.</a><br>
                <a href="#" style="color: #ff4300;"><i class="glyphicon glyphicon-education" style="color: #ff4300;"></i>&nbsp;  Asst. Professor- Gandhi </a>-->
                <p>Designation &nbsp; : &nbsp;Rtd.Cabinet Secretary <br>
                  <!--Post & Office &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;:&nbsp; Medak<Br></p>-->
             </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="feature-item-container-box listing-item">
              ...
              <div class="feature-box-text">
                <h3><a href="#" style="color: #ff4300;">P.Sunder Kumar</a></h3>
                <p>Eiusmod tempor incidiunt labore velit dolore magna aliqu sed veniam quis nostrud lorem ipsum dolor sit amet consectetur...</p>
              </div>
           </div>
          </div>
