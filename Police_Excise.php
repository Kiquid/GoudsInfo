    ...
    <div class="row">
      <div class="col-sm-12 text-center">
        <div class="breadcrum-inner-header">
          <h1>POLICE & EXCISE</h1>
          <a href="index.html">Home</a> <i class="fa fa-circle"></i> <a href="#"><span>POLICE & EXCISE</span></a> </div>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="col-md-3 col-sm-4 col-xs-12">
        ...
        <div class="list-group">
           ...
           high blood pressure, or an irregular heartbeat.">
             <i class="fa fa-hand-o-right"></i> 
             Retd. Excise Superindent
             <span class="list-lt">18</span>
            </a> 
            <!--
           <a href="#" class="list-group-item" data-toggle="tooltip" data-placement="top"
        ...
        <div class="sorts-by-results">
          <div class="col-md-6 col-sm-6 col-xs-6">
             <span class="result-item-view">           
              <span style="color: #ff4300;"><H1>GOUDS in POLICE & EXCISE DEPARTMENT</H1></span>           
            </span>
         </div>
         </div>
        <div class="row">
          <div class="col-md-12 col-sm-8 col-xs-12">
           <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
             Exercitationem sapiente eveniet ipsum harum reprehenderit! Minus 
             quisquam minima quam alias, id porro molestias aliquid aliquam amet 
             maiores dolore veritatis nulla asperiores.</p>
           <!--
          ...
          <div class="col-md-5 col-sm-6 col-xs-12">
            <div class="feature-item-container-box listing-item">
              <div class="feature-title-item">
                <img src="images/product/police-acp.gif" alt="img1" height="45px;"> </div>           
              <div class="feature-box-text">
                <h3><a href="listing_detail.html"> Ambati Narayana</a></h3>
                <a href="#" style="color: #ff4300;"><i class="fa fa-phone" style="color: #ff4300;"></i> +91 949 061 6396</a><BR>
                <a href="#" style="color: #ff4300;"><i class="fa fa-user-md"  style="color: #ff4300;"></i> Assit. Commissioner of Police  (ACP) Rtd</a>
               
               <!-- <p>Fathers Name &nbsp; : &nbsp;A.Balamallu <br>
                  Date of Birth &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;:&nbsp; 05-12-1950<Br>
                  Education&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp; B.Sc<br>
                  Occupation&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; Assit. Commissioner of Police,
                  Sultan Bazar, Koti, Hyderabad Police Department</p>
              <span style="color: #ffce10;">Family Details</span>
              <p>
                Spouse Name&nbsp; :&nbsp;A.Suguna<br>
                Children's&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	: A.Shalini   MBBS<br>
                Native Place&nbsp;&NonBreakingSpace;&nbsp;&nbsp;&nbsp;:Thadkapally, Medak Dist.
              </p>--><br>
                            <span style="color: #ffce10;">Present Address</span>
              <P>H.No : 3-4-735, Narayanaguda, Hyderabad.</P>
              </div>
             </div>
          </div>
          <div class="col-md-5 col-sm-6 col-xs-12">
            <div class="feature-item-container-box listing-item">
              <div class="feature-title-item">
                <img src="images/product/Excise-Rama.gif" alt="img2"> 
              </div>       
              <div class="feature-box-text">
                <h3><a href="listing_detail.html">Vasamsetti Ramakrishna</a></h3>
                <a href="#" style="color: #ff4300;"><i class="fa fa-phone" style="color: #ff4300;"></i> +91 970 456 1333</a><br>
                <a href="#" style="color: #ff4300;"><i class="glyphicon glyphicon-education" style="color: #ff4300;"></i>&nbsp;  Excise Superintend (Rtd ) </a>
                <!--
                <p>Fathers Name &nbsp; : &nbsp;Venkataratnam <br>
                  Date of Birth &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;:&nbsp; 01-11-1949<Br>
                  Education&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;   B.Sc, LLB<br>
                  Occupation&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; Excise Superintend Rtd.</p>
              <span style="color: #ffce10;">Family Details</span>
              <p>
                Spouse Name&nbsp; :&nbsp; V.Aruna<br>
                Children's&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	:  Divya Teja<br>
                Native Place&nbsp;&NonBreakingSpace;&nbsp;&nbsp;&nbsp;:R.C.Puram, East Godavari Dist. 
                 
              </p>--><br>
              <span style="color: #ffce10;">Present  Address</span>
              <P>F.No:404, Ahalya Enclave, 12th Street, Himayathnagar, Hyderabad-29</P>
              </div>
              </div>
            </div>
          </div>
